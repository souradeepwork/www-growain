...
import { MapPin, CheckCircle2, ArrowRight, Target, TrendingUp, Shield, Sparkles, Users, Clock, Star } from "lucide-react";

const sections = [
  {
    title: "Fix How You Show Up",
    description: "Most businesses lose local customers because they're missing, wrong, or buried. We make sure you're present, accurate, and positioned to be chosen.",
    items: [
      "Complete, accurate Google Business Profiles for each location",
      "Correct categories, hours, services, photos, and attributes",
      "Clear descriptions that explain why you're the right choice",
      "Consistent details across major directories",
    ],
  ...
  },
  {
    ...
    description: "The goal isn't just to show up—it's to make your profile irresistible. Clear actions, rich content, and confident presentation close the decision gap.",
    items: [
      "Showcase offers, specialties, and real photos",
      "Pin key actions: call, directions, website, booking",
      "Support for multi-location brands with central control",
    ],
  ...
  },
  {
    ...
    description: "Local rankings shift every day. Competitors make moves. Customers change how they search. We track it all and adjust before you lose ground.",
    items: [
      "Track local rankings and searches in real-time",
      "Monitor profile changes and competitor moves",
      "Automatic adjustments when something shifts",
    ],
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex items-center gap-3 text-sm text-foreground/60">
              ...
              <span>/</span>
              <span className="text-primary">Local Customers</span>
            </div>
            <div className="space-y-6">
              ...
              <h1 className="text-5xl md:text-7xl font-display font-bold text-foreground leading-tight text-glow">
                Turn "near me" searches into new customers.
              </h1>
              <p className="text-xl md:text-2xl text-foreground/85 leading-relaxed">
                When someone nearby searches for what you do, they should find you fast and feel
                confident choosing you. Growain helps clinics, cafés, gyms, pet stores, senior
                services, and local shops stand out in local search and on Google Maps.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="pulse-glow text-lg" asChild>
                  <Link href="/book-demo">
                    Get a Local Growth Plan
            ...
            <Card className="glow-primary-strong border-primary/30 bg-black/60 backdrop-blur-xl">
              <CardContent className="p-8 md:p-16 text-center space-y-8">
                ...
                <p className="text-lg md:text-xl text-foreground/85 max-w-2xl mx-auto leading-relaxed">
                  Get a  local growth plan and see exactly where you can improve your local
                  presence.
                </p>
